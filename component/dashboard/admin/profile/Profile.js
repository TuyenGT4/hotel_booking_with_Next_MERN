...
export default function ProfileUpdateForm() {
  ...
  const validateForm = () => {
    ...
    if (!mobileNumber && !/^[0-9]{10}$/.test(mobileNumber)) {
      errors.mobileNumber = "Vui lòng nhập số điện thoại gồm 10 chữ số";
    }

    if (address && address.length < 5) {
      errors.address = "Vui lòng nhập địa chỉ chi tiết hơn";
    }
    ...
    if (
      ...
      errors.country = "Vui lòng chọn quốc gia hợp lệ";
    }
  ...
  const handleSubmit = async (e) => {
    ...
    if (profileImage) {
      ...
      setIsSuccess(true);
      setServerMessage("Tải ảnh lên thành công");
    }
    ...
    <>
      ...
      >
        ...
        >
          ...
          >
            {/* {JSON.stringify({ profileImagePreview }, null, 4)} */}
            {profileImagePreview && (
