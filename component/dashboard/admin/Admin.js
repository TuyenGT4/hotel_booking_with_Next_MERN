...
import HotelLogo from "@/component/nav/HotelLogo";
...
import TeamList from "@/component/dashboard/admin/teamlist/Team";
  ...
  switch (path) {
      ...
      return (
        <Box>
          <Typography paragraph>
            Xem và quản lý đặt phòng của bạn tại đây.
          </Typography>
    ...
    case "/reports":
      return (
        <Box>
          ...
          <Typography paragraph>Xem báo cáo và phân tích.</Typography>
        </Box>
      );
    case "/sales":
      return (
    ...
    case "/category":
      return (
        <Box>
          <Typography paragraph>
            Quản lý các tích hợp với bên thứ ba.
          </Typography>
          <Category />
        </Box>
      );
    ...
    default:
      return (
        <Box>
          ...
          <Typography>Không tìm thấy trang bạn yêu cầu.</Typography>
        </Box>
      );
  }
};
      ...
      >
        <Toolbar sx={{ minHeight: 72 }}>
          ...
          >
            ...
            {router.pathname === "/orders" && "Danh sách đặt chỗ"}
            {router.pathname === "/profile" && "Hồ sơ quản trị"}

            {router.pathname === "/team" && "Thành viên nhóm"}

            {router.pathname === "/teamlist" && "Danh sách thành viên"}

            {router.pathname === "/snapbooking" && "Đặt phòng nhanh"}

            {router.pathname === "/manageroomcategories" &&
              "Quản lý danh mục phòng"}

            {router.pathname === "/reports" && "Báo cáo"}
            {router.pathname === "/sales" && "Báo cáo doanh thu"}
            {router.pathname === "/traffic" && "Báo cáo lưu lượng truy cập"}
            {router.pathname === "/category" && "Danh mục"}
            {router.pathname === "/blog" && "Bài viết"}
            {router.pathname === "/bloglist" && "Danh sách bài viết"}
            {![
              "/dashboard",
              "/orders",
              "/profile",
              ...
              "/blog",
              "/bloglist",
            ].includes(router.pathname) && "Không tìm thấy trang"}
          </Typography>
          <Box sx={{ flexGrow: 1 }} />
          <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
            <Box
